...
def handle_chat():
    ...
    if user_input:
        ...
        if st.session_state["step"] == "welcome":
            st.session_state["messages"].append({"role": "assistant", "content": "Welcome to UNITY-TECH Appointment System! Let me help you book an appointment with a doctor today."})
            ...
            if user_input == "1":
                ...
                st.session_state["messages"].append({"role": "assistant", "content": "Thank you for using UNITY-TECH Appointment System. Goodbye!"})
                st.session_state["step"] = None
            else:
                st.session_state["messages"].append({"role": "user", "content": user_input})
...
def main():
    ...
    st.markdown(
        '<div class="title"> UNITY-TECH </div>',
        unsafe_allow_html=True
    )
